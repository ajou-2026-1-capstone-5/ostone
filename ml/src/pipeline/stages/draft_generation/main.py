                ...
                "sourceClusterRef": _compact_json(
                    {
                        ...
                        "segmentIds": _string_list(group.get("memberIds"), limit=100),
                        "segments": _segment_details(
                            _string_list(group.get("memberIds"), limit=100),
                            preprocessed_index,
                            limit=100,
                        ),
                    }
                ...
                "sourceClusterRef": _compact_json(
                    {
                        ...
                        "segmentIds": _string_list(member_conv_ids, limit=100),
                        "segments": _segment_details(member_conv_ids, preprocessed_index, limit=100),
