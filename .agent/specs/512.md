...
pnpm exec eslint \
  src/app/App.tsx \
  src/pages/domain-pack/ui/DomainPackListPage.tsx \
  src/pages/domain-pack/ui/DomainPackSummaryPage.tsx \
  src/pages/domain-pack/ui/LegacyDomainPackVersionRedirect.tsx \
  src/shared/ui/ostone/chrome/Sidebar.tsx \
  src/widgets/ostone-shell/ui/OstoneShell.tsx
```
