...
| ------------- | ------- | -------- | ------------------------- |
| `name`        | string? | ❌       | 1–255자, blank 금지       |
| `description` | string? | ❌       | 최대 2000자, null 허용    |
...
- `should_name만_수정_when_description_null`
  - then: description 필드가 null 전달 시 null로 덮어씀
