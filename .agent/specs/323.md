...
| `frontend/src/features/update-risk/ui/JsonTextarea.test.tsx` | JSON textarea 렌더링/에러 테스트 |
| `frontend/src/features/update-risk/ui/RiskEditForm.test.tsx` | form validation/submit 테스트 |
| `frontend/src/features/update-risk/ui/RiskEditPanel.test.tsx` | loading/error/ready 상태 테스트 |
