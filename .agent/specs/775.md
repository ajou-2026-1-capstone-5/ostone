...
- `feedback_candidate_generation` 이후 또는 내부에서 LLM 기반 review question enrichment를 수행한다.
...
- `LLM_RUNTIME_BASE_URL`이 없거나 LLM 호출이 실패하면 기존 deterministic 질문 생성 동작이 유지된다.
