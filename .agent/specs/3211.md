...
**404 Not Found** (version 없음 또는 slot 없음)
...
| `JpaSlotDefinitionRepository.java` | 위 두 메서드를 Spring Data JPA 파생 쿼리로 구현 (자동 생성) |
...
List<SlotDefinition> findAllByVersionIdOrderedByCode(@Param("versionId") Long versionId);
