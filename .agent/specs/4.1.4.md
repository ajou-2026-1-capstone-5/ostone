...
| seqNo | currentNodeId | incomingEdgeId | policyRef | slotRefs | state |
|-------|---------------|----------------|-----------|----------|-------|
| 1 | `start` | `null` | `null` | `[]` | `started` |
| 2 | `n1` | `e1` | `refund_amount_check` | `["order_number", "refund_amount"]` | `checking_amount` |
| 3 | `n3` | `e3` | `return_deadline_check` | `["order_number"]` | `checking_deadline` |
| 4 | `n5` | `e6` | `high_value_alert` | `["customer_name", "contact_number"]` | `agent_note` |
| 5 | `end_requested` | `e8` | `null` | `["contact_number"]` | `refund_requested` |
