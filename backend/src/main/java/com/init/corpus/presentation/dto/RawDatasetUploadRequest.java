...
public record RawDatasetUploadRequest(
    ...
    @NotBlank(message = "sourceType은 필수입니다.") @Size(max = 50, message = "sourceType은 50자 이하여야 합니다.")
        String sourceType,
    @NotNull(message = "conversations는 필수입니다.")
        @Size(min = 1, max = 10000, message = "대화는 1개 이상 10000개 이하여야 합니다.")
  ...
  public record RawConversationRequest(
      @JsonProperty("source_id")
          ...
          String sourceId,
      @JsonProperty("source") @Size(max = 255, message = "source는 255자 이하여야 합니다.") String source,
      @JsonProperty("consulting_category")
          @Size(max = 100, message = "consulting_category는 100자 이하여야 합니다.")
          String consultingCategory,
      @JsonProperty("client_gender") @Size(max = 10, message = "client_gender는 10자 이하여야 합니다.")
          String clientGender,
      @JsonProperty("client_age") @Size(max = 10, message = "client_age는 10자 이하여야 합니다.")
          String clientAge,
