...
interface WorkflowGraphMiniSvgProps {
  workflowId: number;
  graphJson: unknown;
}
...
export function WorkflowGraphMiniSvg({ workflowId, graphJson }: WorkflowGraphMiniSvgProps) {
  const graph = useMemo(() => {
    const parsed = safeParseGraph(graphJson);
