...
export const passwordResetInit = async (
  passwordResetInitRequest: PasswordResetInitRequest,
  options?: RequestInit,
  ...
  return customFetch<passwordResetInitResponse>(getPasswordResetInitUrl(), {
    ...
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(passwordResetInitRequest),
  });
};

export const getPasswordResetInitMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type PasswordResetInitMutationResult = NonNullable<
  Awaited<ReturnType<typeof passwordResetInit>>
>;
export type PasswordResetInitMutationBody = PasswordResetInitRequest;
export type PasswordResetInitMutationError = unknown;

export const usePasswordResetInit = <TError = unknown, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof passwordResetInit>>,
      TError,
...
export const getPasswordResetCompleteMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type PasswordResetCompleteMutationResult = NonNullable<
  Awaited<ReturnType<typeof passwordResetComplete>>
>;
...
export const usePasswordResetComplete = <TError = unknown, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof passwordResetComplete>>,
      TError,
