...
export const LatestPipelineJobItem = zod.object({
...
export type LatestPipelineJobItem = zod.input<typeof LatestPipelineJobItem>;
export type LatestPipelineJobItemOutput = zod.output<typeof LatestPipelineJobItem>;
