...
export const AdminCustomerSummaryResponse = zod.object({
...
export type AdminCustomerSummaryResponse = zod.input<typeof AdminCustomerSummaryResponse>;
export type AdminCustomerSummaryResponseOutput = zod.output<typeof AdminCustomerSummaryResponse>;
