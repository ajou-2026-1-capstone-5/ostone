...
export const createDraftBodyWorkflowsItemIntentCodeMin = 0;
export const createDraftBodyWorkflowsItemIntentCodeMax = 100;

export const createDraftBodyWorkflowsItemRouteConditionJsonMin = 0;
export const createDraftBodyWorkflowsItemRouteConditionJsonMax = 5000;
...
export const CreateDraftBody = zod.object({
  ...
  "intentCode": zod.string().min(createDraftBodyWorkflowsItemIntentCodeMin).max(createDraftBodyWorkflowsItemIntentCodeMax).optional(),
  "isPrimary": zod.boolean().optional(),
  "routeConditionJson": zod.string().min(createDraftBodyWorkflowsItemRouteConditionJsonMin).max(createDraftBodyWorkflowsItemRouteConditionJsonMax).optional()
