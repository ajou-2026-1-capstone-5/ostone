...
export const CreateDomainPackDraftRequest = zod.object({
  ...
  "intentCode": zod.string().min(createDomainPackDraftRequestWorkflowsItemIntentCodeMin).max(createDomainPackDraftRequestWorkflowsItemIntentCodeMax).optional(),
  "isPrimary": zod.boolean().optional(),
  "routeConditionJson": zod.string().min(createDomainPackDraftRequestWorkflowsItemRouteConditionJsonMin).max(createDomainPackDraftRequestWorkflowsItemRouteConditionJsonMax).optional()
