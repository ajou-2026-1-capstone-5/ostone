...
export const receiveWorkflowDraftCallbackBodyWorkflowsItemIntentCodeMin = 0;
export const receiveWorkflowDraftCallbackBodyWorkflowsItemIntentCodeMax = 100;

export const receiveWorkflowDraftCallbackBodyWorkflowsItemRouteConditionJsonMin = 0;
export const receiveWorkflowDraftCallbackBodyWorkflowsItemRouteConditionJsonMax = 5000;

export const receiveWorkflowDraftCallbackBodyWorkflowsMin = 0;
export const receiveWorkflowDraftCallbackBodyWorkflowsMax = 200;
...
export const ReceiveWorkflowDraftCallbackBody = zod.object({
  ...
  "intentCode": zod.string().min(receiveWorkflowDraftCallbackBodyWorkflowsItemIntentCodeMin).max(receiveWorkflowDraftCallbackBodyWorkflowsItemIntentCodeMax).optional(),
  "isPrimary": zod.boolean().optional(),
  "routeConditionJson": zod.string().min(receiveWorkflowDraftCallbackBodyWorkflowsItemRouteConditionJsonMin).max(receiveWorkflowDraftCallbackBodyWorkflowsItemRouteConditionJsonMax).optional()
  ...
  "finalCallback": zod.boolean().optional()
})
